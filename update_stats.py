#!/usr/bin/env python3
"""
Build and refresh the Hugging Face GitHub repository catalog.

The script fetches public GitHub metadata for repositories in Hugging Face's
huggingface organization that were updated in the last three months and have
more than 200 stars, groups them into ecosystem clusters, and rewrites
index.html.
...
USER_AGENT = "huggingface-repos-catalog"
AUTO_KEYWORD_TERMS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("Transformers", ("transformer", "transformers", "attention")),
    ("Diffusion", ("diffusion model", "image generation", "video generation")),
    ("Agents", ("agent", "agents", "agentic")),
    ("LLM", ("large language model", "llm", "language model")),
    ("Reinforcement Learning", ("reinforcement learning", "rlhf", "post training")),
    ("Fine-tuning", ("fine-tuning", "finetuning", "parameter-efficient")),
    ("Inference", ("inference", "serving", "quantization")),
    ("Datasets", ("dataset", "data processing", "data pipeline")),
    ("Evaluation", ("evaluation", "benchmark", "leaderboard")),
    ("Robotics", ("robot", "robotics", "lerobot")),
    ("Vision", ("computer vision", "image", "3d")),
...
CLUSTERS: tuple[Cluster, ...] = (
    Cluster(
        ...
        "Transformers, diffusion models, embeddings, tokenization, Rust ML, and reusable model libraries.",
        "blue",
        (
            "diffusion",
            "embedding",
    ...
    Cluster(
        "agents-rl-alignment",
        "Agents, RL & Alignment",
        "Coding agents, agent skills, environments, reinforcement learning, preference alignment, and post-training.",
        "purple",
        (
            "agent",
            "alignment",
    ...
    Cluster(
        ...
        "Training, Inference & Optimization",
        "Distributed training, fine-tuning, inference servers, hardware acceleration, kernels, and quantization.",
        "cyan",
        (
            "accelerate",
            "distributed",
    ...
    Cluster(
        "data-evaluation-hub",
        "Data, Evaluation & Hub Infrastructure",
        "Dataset tooling, evaluation, leaderboards, Hub clients, storage, transfer, and content infrastructure.",
        "green",
        (
            "benchmark",
            "data",
    ...
    Cluster(
        "robotics-vision-audio",
        "Robotics, Vision, Audio & Multimodal",
        "Robotics, computer vision, image and video generation, 3D, speech, audio, and multimodal systems.",
        "yellow",
        (
            "3d",
            "audio",
    ...
    Cluster(
        "apps-web-devtools",
        "Apps, Web & Developer Tools",
        "Web and native apps, JavaScript and Swift libraries, editors, interfaces, and developer integrations.",
        "red",
        (
            "app",
            "editor",
    ...
    Cluster(
        "education-community",
        "Education, Courses & Community",
        "Courses, notebooks, cookbooks, documentation, blog content, tutorials, and community resources.",
        "orange",
        (
            "blog",
            "cookbook",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Update Hugging Face GitHub repository catalog.")
...
def cluster_repo(repo: dict[str, Any]) -> Cluster:
    ...
    name_overrides = {
        "transformers": "models-libraries",
        "pytorch-image-models": "models-libraries",
        "diffusers": "models-libraries",
        "sentence-transformers": "models-libraries",
        "tokenizers": "models-libraries",
        "candle": "models-libraries",
        "smollm": "models-libraries",
        "agents-course": "education-community",
        "smolagents": "agents-rl-alignment",
        ...
        "autotrain-advanced": "training-inference-optimization",
        "optimum": "training-inference-optimization",
        "nanotron": "training-inference-optimization",
        "finetrainers": "training-inference-optimization",
        "optimum-quanto": "training-inference-optimization",
        "optimum-nvidia": "training-inference-optimization",
        "kernels": "training-inference-optimization",
        "optimum-intel": "training-inference-optimization",
        "optimum-neuron": "training-inference-optimization",
        "optimum-habana": "training-inference-optimization",
        "gpu-fryer": "training-inference-optimization",
        "setfit": "training-inference-optimization",
        "datasets": "data-evaluation-hub",
        "datatrove": "data-evaluation-hub",
        "lighteval": "data-evaluation-hub",
        "evaluate": "data-evaluation-hub",
        "huggingface_hub": "data-evaluation-hub",
        "dataset-viewer": "data-evaluation-hub",
        "hf-mount": "data-evaluation-hub",
        "hf_transfer": "data-evaluation-hub",
        "xet-core": "data-evaluation-hub",
        ...
        "anylanguagemodel": "apps-web-devtools",
        "llm-ls": "apps-web-devtools",
        "responses.js": "apps-web-devtools",
        "smol-course": "education-community",
        "diffusion-models-class": "education-community",
        "course": "education-community",
        "notebooks": "education-community",
        "blog": "education-community",
        "cookbook": "education-community",
        "ai-deadlines": "education-community",
        "mcp-course": "education-community",
        "hub-docs": "education-community",
        "adk-python": "agents-rl-alignment",
        "adk-samples": "agents-rl-alignment",
        "agents-cli": "agents-rl-alignment",
        "ax": "agents-rl-alignment",
        "brax": "agents-rl-alignment",
        "edward2": "agents-rl-alignment",
        "flax": "agents-rl-alignment",
        "gemma.cpp": "agents-rl-alignment",
        "langfun": "agents-rl-alignment",
        "langextract": "agents-rl-alignment",
        "magika": "agents-rl-alignment",
        "ml-compiler-opt": "agents-rl-alignment",
        "ml_collections": "agents-rl-alignment",
        "paxml": "agents-rl-alignment",
        "pyglove": "agents-rl-alignment",
        "seqio": "agents-rl-alignment",
        "sentencepiece": "agents-rl-alignment",
        "skills": "agents-rl-alignment",
        "torchax": "agents-rl-alignment",
        "tunix": "agents-rl-alignment",
        "xnnpack": "agents-rl-alignment",
        "yggdrasil-decision-forests": "agents-rl-alignment",
        "auto": "apps-web-devtools",
        "brotli": "apps-web-devtools",
        "built_collection.dart": "apps-web-devtools",
        "built_value.dart": "apps-web-devtools",
        "commonlooputils": "apps-web-devtools",
        "comprehensive-rust": "apps-web-devtools",
        "double-conversion": "apps-web-devtools",
        "etils": "apps-web-devtools",
        "farmhash": "apps-web-devtools",
        "flatbuffers": "apps-web-devtools",
        "go-cmp": "apps-web-devtools",
        "gson": "apps-web-devtools",
        "guava": "apps-web-devtools",
        "googletest": "apps-web-devtools",
        "go-github": "apps-web-devtools",
        "go-jsonnet": "apps-web-devtools",
        "googlesql": "data-evaluation-hub",
        "json_serializable.dart": "apps-web-devtools",
        "libphonenumber": "apps-web-devtools",
        "mozc": "apps-web-devtools",
        "python-fire": "apps-web-devtools",
        "riegeli": "apps-web-devtools",
        "snappy": "apps-web-devtools",
        "starlark-go": "apps-web-devtools",
        "styleguide": "apps-web-devtools",
        "wireit": "apps-web-devtools",
        "zx": "apps-web-devtools",
        "android-emulator-container-scripts": "training-inference-optimization",
        "cadvisor": "training-inference-optimization",
        "crosvm": "training-inference-optimization",
        "fuse-archive": "training-inference-optimization",
        "go-cloud": "training-inference-optimization",
        "go-containerregistry": "training-inference-optimization",
        "gvisor": "training-inference-optimization",
        "inverting-proxy": "training-inference-optimization",
        "nomulus": "training-inference-optimization",
        "packetdrill": "training-inference-optimization",
        "quiche": "training-inference-optimization",
        "tcmalloc": "training-inference-optimization",
        "atheris": "data-evaluation-hub",
        "bindiff": "data-evaluation-hub",
        "boringssl": "data-evaluation-hub",
        "breakpad": "data-evaluation-hub",
        "bughunters": "data-evaluation-hub",
        "capslock": "data-evaluation-hub",
        "certificate-transparency-go": "data-evaluation-hub",
        "clusterfuzz": "data-evaluation-hub",
        "csp-evaluator": "data-evaluation-hub",
        "der-ascii": "data-evaluation-hub",
        "go-attestation": "data-evaluation-hub",
        "go-tpm": "data-evaluation-hub",
        "go-tpm-tools": "data-evaluation-hub",
        "gwpsan": "data-evaluation-hub",
        "heir": "data-evaluation-hub",
        "longfellow-zk": "data-evaluation-hub",
        "mantis": "data-evaluation-hub",
        "nsjail": "data-evaluation-hub",
        "oss-fuzz": "data-evaluation-hub",
        "oss-rebuild": "data-evaluation-hub",
        "osv-scalibr": "data-evaluation-hub",
        "osv-scanner": "data-evaluation-hub",
        "private-compute-services": "data-evaluation-hub",
        "safehtml": "data-evaluation-hub",
        "sanitizers": "data-evaluation-hub",
        "security-research": "data-evaluation-hub",
        "syzkaller": "data-evaluation-hub",
        "vxsig": "data-evaluation-hub",
        "angle": "robotics-vision-audio",
        "brunsli": "robotics-vision-audio",
        "dawn": "robotics-vision-audio",
        "draco": "robotics-vision-audio",
        "fonts": "robotics-vision-audio",
        "filament": "robotics-vision-audio",
        "jpegli": "robotics-vision-audio",
        "libultrahdr": "robotics-vision-audio",
        "model-viewer": "robotics-vision-audio",
        "skia": "robotics-vision-audio",
        "swiftshader": "robotics-vision-audio",
        "woff2": "robotics-vision-audio",
        "zimtohrli": "robotics-vision-audio",
        "android-cuttlefish": "apps-web-devtools",
        "automotive-design-compose": "apps-web-devtools",
        "horologist": "apps-web-devtools",
        "ksp": "apps-web-devtools",
        "material-design-icons": "apps-web-devtools",
        "material-design-lite": "apps-web-devtools",
        "nearby": "apps-web-devtools",
        "site-kit-wp": "apps-web-devtools",
        "visualblocks": "apps-web-devtools",
        "earthengine-api": "data-evaluation-hub",
        "earthengine-community": "data-evaluation-hub",
        "fhir": "data-evaluation-hub",
        "gnm": "data-evaluation-hub",
        "grain": "data-evaluation-hub",
        "jax-cfd": "data-evaluation-hub",
        "jaxopt": "data-evaluation-hub",
        "learned_optimization": "data-evaluation-hub",
        "meridian": "data-evaluation-hub",
        "ml-metadata": "data-evaluation-hub",
        "or-tools": "data-evaluation-hub",
        "s2geometry": "data-evaluation-hub",
        "tensorstore": "data-evaluation-hub",
    }
...
<title>Hugging Face GitHub Repository Atlas</title>
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .jump-nav a:hover {{
    border-color: var(--huggingface);
    color: var(--huggingface);
  ...
  .activity-bar span {{
    ...
    background: linear-gradient(90deg, #ffb000, #ffd21e, #ff6f91);
  }}
  ...
  .footer a {{ color: var(--huggingface); text-decoration: none; }}
...
<body>
  <header class="header page-header">
    <h1 class="page-title"><span class="logo-box">HF</span>Hugging Face GitHub Repository Atlas</h1>
    <p>Searchable snapshot of public repositories from Hugging Face's <a href="https://github.com/orgs/huggingface/repositories" target="_blank" rel="noreferrer">huggingface organization</a>. Included repositories have more than 200 stars and were pushed within the last three months, since {cutoff}.</p>
    <div class="metric-strip" aria-label="Catalog summary">
      ...
      <div class="metric-card"><strong>{len(CLUSTERS)}</strong><span>ecosystem clusters</span></div>
    </div>
...
{extra_section_html}
  ...
  <footer class="footer">
    <p style="margin-bottom: 10px;">Useful links:
      <a class="gh-link" href="https://huggingface.co/" target="_blank" rel="noreferrer" style="display: inline; margin-left: 6px;">Hugging Face Hub</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://huggingface.co/papers" target="_blank" rel="noreferrer" style="display: inline;">Daily Papers</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://huggingface.co/docs" target="_blank" rel="noreferrer" style="display: inline;">Documentation</a>
    </p>
...
def main() -> int:
    ...
    print(f"Wrote {args.file} with {len(repos)} Hugging Face repositories")
